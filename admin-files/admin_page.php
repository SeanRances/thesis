                ...
                <div class="text-center">
                  ...
                  ?><p>No records yet.</p><?php
                    ...
                    <a href="admin_view_emp_perf.php?post=<?php echo $check_perf ?>">
                      <img alt="nope" class=" emp img-thumbnail img-fluid" style="height: 150px;" src="../img/<?php echo $day_image ?>" />
                    </a>
                          ...
                          <div class="accordion-item">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                              <div class="accordion-body">
                                ...
                                <p class="text-muted mb-0"> <code> Charts Per Hour </code> </p>
                              </div>
                            </div>
                          </div>
                          <div class="accordion-item">
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                              <div class="accordion-body">
                                <div class="wrapper">
                                  ...
                                  <p class="text-muted mb-0"> <code> Quality Assurance </code> </p>
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="accordion-item">
                            ...
                            <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                              <div class="accordion-body">
                                ...
                                <p class="text-muted mb-0"> <code> Attendance </code> </p>
                              </div>
                            </div>
                          </div>
                          <div class="accordion-item">
                                ...
                                <script>
                                  new Chart(document.getElementById("pie-chart"), {
                                    ...
                                    data: {
                                      ...
                                      datasets: [{
                                        backgroundColor: ["#3e95cd", "#8e5ea2", "#3cba9f"],
                                        data: [<?php echo $QA_score_emp; ?>, <?php echo $CPH_score_emp; ?>, 100]
                                      }]
                                    },
                                    options: {
                                      title: {
